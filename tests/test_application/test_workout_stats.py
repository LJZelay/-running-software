...
def plot_split_distribution(interval, figsize=(6,4)):
    fig, ax = plt.subplots(figsize=figsize)
    if interval.splits_ms:
        ...
        ax.text(0.5, 0.5, 'No splits recorded', horizontalalignment='center', verticalalignment='center')
    fig.tight_layout()
    return fig